    ...
    for stage, epochs in enumerate(args.stages):
        ...
        if args.scr == True:
            ...
            if args.use_rlu == False:
                ...
                if args.dataset == "ogbn-mag":
                    _, num_feats, in_feats = feats[0].shape
                    teacher_model = gen_model_mag(args, num_feats, in_feats, num_classes)
                else:
                ...
                if args.dataset == "ogbn-mag":
                    _, num_feats, in_feats = feats[0].shape
                    teacher_model = gen_model_mag_rlu(args, num_feats, in_feats, num_classes)
                else:
        ...
        for epoch in range(epochs):
            ...
            if args.scr == False:
                ...
                if epoch < (args.warm_up + 1) :
                    ...
                    loss, acc = train_scr(model,teacher_model,feats, labels, device, loss_fcn, optimizer, train_loader,enhance_loader, label_emb, evaluator,args, global_step)
                    global_step += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--emb_path", type=str, default='../../mag_emb')
    parser.add_argument("--use-relation-subsets", type=str, default='./data/mag')
